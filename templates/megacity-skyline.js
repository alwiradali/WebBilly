...
(() => {
  ...
  const PAGES = [
    ...
    { t: "Fees & pricing", d: "5% rent collection, 10% full management, and what high street agents charge", u: "megacity-for-landlords#fees", k: "fees pricing cost charges percent compare cheap high street" },
    { t: "Tenant Sourcing", d: "\u00a3295 for landlords new to Megacity: marketing, vetting, paperwork", u: "megacity-tenant-find", k: "tenant sourcing tenant find 295 let only advertise vetting referencing" },
    { t: "Rent Collection", d: "Tenant Sourcing plus the rent chased and paid over, at 5%", u: "megacity-rent-collection", k: "rent collection 5 arrears chase statements" },
    { t: "Full Management", d: "The whole tenancy handled end to end, at 10%", u: "megacity-fully-managed", k: "full management fully managed 10 complete repairs inspections" },
    ...
    { t: "Letting agents in Manchester", d: "Homes to rent and landlord services across the city", u: "megacity-area-manchester", k: "manchester area letting agents hulme oxford road m8 m15 local" },
    { t: "Letting agents in Salford", d: "Rooms, apartments and family homes, and Salford's licensing", u: "megacity-area-salford", k: "salford area letting agents university quays mediacity eccles m5 m6 m7 m50 local" },
    { t: "Letting agents in Swinton", d: "Family homes in the City of Salford, M27", u: "megacity-area-swinton", k: "swinton pendlebury m27 area letting agents salford local" },
    { t: "Letting agents in Old Trafford", d: "Trafford Council, M16 and the Altrincham line", u: "megacity-area-old-trafford", k: "old trafford m16 trafford area letting agents local" },
    { t: "Letting agents in Manchester city centre", d: "Apartments in managed blocks, M1 to M4", u: "megacity-area-city-centre", k: "city centre town centre m1 m2 m3 m4 apartments area letting agents northern quarter ancoats deansgate local" },
