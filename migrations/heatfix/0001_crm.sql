...
-- ------------------------------------------------------------------ seed
-- review_url is deliberately NOT here: it is added by 0002. Declaring it in
-- both makes `d1 migrations apply` fail on a fresh database with "duplicate
-- column name", and this file has to keep matching the schema the live
